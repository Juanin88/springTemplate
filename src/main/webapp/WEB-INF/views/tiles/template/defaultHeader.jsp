...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="index.htm">M�dulo de Gesti�n de Campa�as</a>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
            ...
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Campa�as">
                <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseCampanas" data-parent="#accordionCampanas">
                    ...
                    <span class="nav-link-text">Campa�as</span>
                </a>
                <ul class="sidenav-second-level collapse" id="collapseCampanas">
                    ...
                    <li>
                        <a href="<c:url value='/campaign/newCampaign.htm' />">Nueva Campa�a</a>
                    </li>
                    <li>
